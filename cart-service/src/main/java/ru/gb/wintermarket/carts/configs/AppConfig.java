package ru.gb.wintermarket.carts.configs;
...
import ru.gb.wintermarket.carts.properties.ProductServiceIntegrationProperties;
...
//    }
    @Bean
    public WebClient productCartServiceWebClient() {
